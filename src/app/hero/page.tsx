...
export default function HomePage() {
  return (
    <div className='pt-[80px] pb-5 bg-[#E8FFFB] px-5 md:px-10 grid grid-cols-1 lg:grid-cols-2 gap-5 items-center'>
      <section className='text-center md:text-left'>
        <div className='text-4xl md:text-5xl mt-5 flex flex-col gap-2 font-semibold'>
          <h1>Ignite Your</h1>
        ...
        <Link href={'/getinvolved'}>
          <button className='bg-[#008080] text-white py-2 my-4 px-4 rounded hover:bg-[#0a5f5f] transition-all duration-300'>
            Join the Movement
          </button>
        </Link>
        <div className='flex justify-center md:justify-start gap-5 text-2xl mt-4'>
          <FaTiktok className='hover:text-[#000000] cursor-pointer' />
        ...
        <div className='mt-6 '>
          ...
          <h1 className='text-lg font-semibold py-2'>A Life-Changing Experience!</h1>
          <p className='text-sm'>
